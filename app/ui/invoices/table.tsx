...
import { fetchFilteredSample } from '@/app/lib/data';
...
export default async function SampleTable({
  ...
  const samples = await fetchFilteredSample(query, currentPage);
                ...
                >
                  <td className="whitespace-nowrap py-3 pl-6 pr-3">
                    <div className="flex items-center gap-3">
                      <DigantiStatus status={sample.status} idsbr={sample.idsbr} />
                    </div>
                  </td>
